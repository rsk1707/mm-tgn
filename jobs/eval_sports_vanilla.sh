#!/bin/bash
#SBATCH --job-name=eval_sports_vanilla
...
#SBATCH --output=logs/eval_sports_vanilla_%j.out
#SBATCH --error=logs/eval_sports_vanilla_%j.err

# ==============================================================================
# MM-TGN Evaluation: Amazon Sports - Vanilla (Random Features)
# Full ranking evaluation on test set
# ==============================================================================

echo "📊 MM-TGN Evaluation: Amazon Sports Vanilla"
echo "Date: $(date)"
echo "Node: $(hostname)"
echo ""
...
CHECKPOINT_DIR=$(ls -td checkpoints/sports_vanilla_* 2>/dev/null | head -1)
