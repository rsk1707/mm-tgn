#!/bin/bash
#SBATCH --job-name=eval_sports_film
...
#SBATCH --output=logs/eval_sports_sota_film_%j.out
#SBATCH --error=logs/eval_sports_sota_film_%j.err

# ==============================================================================
# MM-TGN Evaluation: Amazon Sports - SOTA Features (FiLM Fusion)
# Full ranking evaluation on test set
# ==============================================================================

echo "📊 MM-TGN Evaluation: Amazon Sports SOTA (FiLM)"
echo "Date: $(date)"
echo "Node: $(hostname)"
echo ""
...
CHECKPOINT_DIR=$(ls -td checkpoints/sports_sota_film_* 2>/dev/null | head -1)
