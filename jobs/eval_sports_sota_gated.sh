#!/bin/bash
#SBATCH --job-name=eval_sports_gated
...
#SBATCH --output=logs/eval_sports_sota_gated_%j.out
#SBATCH --error=logs/eval_sports_sota_gated_%j.err

# ==============================================================================
# MM-TGN Evaluation: Amazon Sports - SOTA Features (Gated Fusion)
# Full ranking evaluation on test set
# ==============================================================================

echo "📊 MM-TGN Evaluation: Amazon Sports SOTA (Gated)"
echo "Date: $(date)"
echo "Node: $(hostname)"
echo ""
...
# Find the latest SOTA Gated checkpoint
CHECKPOINT_DIR=$(ls -td checkpoints/sports_sota_gated_* 2>/dev/null | head -1)
