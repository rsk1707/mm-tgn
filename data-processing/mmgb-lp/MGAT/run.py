...
def batch_evaluate_model(
    representation: torch.Tensor, triple_data, batch_size=256, verbose=False
):
...
def hyperparameter_search(
    train_dataloader, args, features, edge_index, num_nodes, val_triple_data
):
    def objective(trial):
        ...
        optimizer = torch.optim.Adam(
            [{"params": model.parameters(), "lr": lr}], weight_decay=args.weight_decay
        )
        val_max_mrr = 0
